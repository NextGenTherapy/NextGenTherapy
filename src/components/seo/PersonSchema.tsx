...
export default function PersonSchema({ className }: PersonSchemaProps) {
  const personSchema: Person = {
    ...
    "description": "BACP registered psychodynamic psychotherapist specializing in anxiety, depression, relationships, and personal growth. Providing professional therapy services in Colchester and online.",
