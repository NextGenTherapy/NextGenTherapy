          ...
          <section className={styles.locationDetails}>
            <div className={styles.detailsGrid}>
              <div className={styles.addressCard}>
                <h2>Address</h2>
                <address>
                  <strong>Next Generation Therapy</strong>
                  <br />
              ...
              <div className={styles.contactCard}>
                ...
                <div className={styles.contactButtons}>
                  <Button href="/book-now">Book Appointment</Button>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className={styles.directionsSection}>
            ...
            <div className={styles.directionsGrid}>
              <div className={styles.directionCard}>
                <h3>🚗 By Car</h3>
                <p>
                  Free parking is available on-site. The Business Centre is easily accessible from
                  the A12 and A120. Use postcode CO1 2JS for your sat nav.
                </p>
              </div>
              <div className={styles.directionCard}>
                <h3>🚌 By Bus</h3>
                <p>
                  Several bus routes stop near George Williams Way. Check local bus timetables for
                  the most convenient route from your location.
                </p>
              </div>
              <div className={styles.directionCard}>
                <h3>🚂 By Train</h3>
                <p>
                  Colchester Station is approximately 1.5 miles away. You can take a taxi, bus, or
                  walk to the Business Centre from the station.
                </p>
              </div>
            </div>
          </section>
