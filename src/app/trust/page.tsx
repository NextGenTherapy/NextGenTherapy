...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: 'Professional counsellor committed to trust and care with BACP ethical standards.',
            ...
            <div className={styles.approach}>
              ...
              <div className={styles.commitmentGrid}>
                <div className={styles.commitmentItem}>
                  ...
                  <p>
                    Every session takes place in a confidential, non-judgmental space where you can
                    explore your thoughts and feelings freely.
                  </p>
                </div>
                <div className={styles.commitmentItem}>
                  <h3>Professional Standards</h3>
                  <p>
                    As a BACP registered therapist, I maintain the highest standards of professional
                ...
                <div className={styles.commitmentItem}>
                  ...
                  <p>
                    Using psychodynamic therapy principles, I tailor each session to your unique
                ...
                <div className={styles.commitmentItem}>
                  ...
                  <p>
                    Your privacy is paramount. Everything discussed in our sessions remains strictly
                    confidential.
                  </p>
                </div>
              </div>
          ...
          <section className={styles.qualificationsSection}>
            ...
            <div className={styles.qualifications}>
              ...
              <div className={styles.qualification}>
                ...
                <p>
                  Regular professional supervision ensures continued development and maintains the
                  highest quality of care for all clients.
                </p>
              </div>
            </div>
          </section>
