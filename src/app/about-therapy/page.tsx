...
export default function AboutTherapy() {
  const structuredData = {
    ...
    name: 'About Therapy',
    description:
      "Learn about therapy, who it's for, and how it can help with mental health and personal growth.",
    provider: {
      '@type': 'Person',
  ...
  const courseSchema = {
    ...
    description:
      'Comprehensive guide to therapy benefits, process, and what to expect from professional psychodynamic therapy in Colchester',
    provider: {
      '@type': 'Person',
      name: 'Andreea Horhocea',
        ...
        <main className={styles.main}>
          ...
          <section className={styles.whyTherapySection}>
            <article className={styles.textContent}>
              ...
              <p>
                Therapy can help when you&apos;re feeling anxious, overwhelmed, or struggling to
                manage emotions. It provides support for navigating challenges in relationships,
                fostering meaningful connections, and improving communication.
              </p>
              <p>
                It offers a space for self-reflection, helping you rediscover your values, process
                significant life events, and adapt to major transitions like career changes or loss.
              </p>
              <p>
                Therapy is a valuable tool for addressing unhealthy coping mechanisms, building
                self-confidence, and fostering a healthier relationship with yourself. It provides a
                safe, non-judgmental environment to explore feelings and grow emotionally.
              </p>
            </article>
          </section>
          ...
          <section className={styles.howTherapyHelpsSection}>
            ...
            <div className={styles.benefitsGrid}>
              <div className={styles.benefitCard}>
                ...
                <p>
                  Therapy helps individuals gain a deeper understanding of themselves, providing a
                  structured environment to explore thoughts, feelings, and behaviors.
                </p>
              </div>
              <div className={styles.benefitCard}>
                <h3>Coping with Life Transitions</h3>
                <p>
                  Whether it&apos;s starting a new job, moving, marriage, divorce, or retirement,
                  therapy provides support and guidance during changes.
                </p>
              </div>
              <div className={styles.benefitCard}>
                <h3>Improving Relationships</h3>
                <p>
                  Therapy enhances interpersonal skills and improves relationships through better
              ...
              <div className={styles.benefitCard}>
                ...
                <p>
                  Regular therapy builds emotional resilience, equipping you with tools to handle
                  future stressors and challenges more effectively.
                </p>
              </div>
              <div className={styles.benefitCard}>
                <h3>Managing Stress & Anxiety</h3>
                <p>
                  Learn practical techniques to manage everyday stress and anxiety, promoting a more
              ...
              <div className={styles.benefitCard}>
                ...
                <p>
                  Like physical health, mental health benefits from preventative care, helping
              ...
              <div className={styles.benefitCard}>
                ...
                <p>
                  Many people experience subclinical issues that aren&apos;t severe enough to
                  qualify as a mental disorder but still affect quality of life, such as mild
              ...
              <div className={styles.benefitCard}>
                ...
                <p>
                  For those with chronic mental health conditions, ongoing therapy provides
                  continuous support and management strategies to maintain stability and improve
                  quality of life.
                </p>
              </div>
              <div className={styles.benefitCard}>
                ...
                <p>
                  Therapists can assist in developing and maintaining positive habits and routines,
                  such as exercise, mindfulness, and healthy eating, which contribute to overall
                  well-being.
                </p>
              </div>
              <div className={styles.benefitCard}>
                ...
                <p>
                  Therapy empowers individuals by giving them tools to handle various life
                  situations confidently, fostering a sense of control and competence that enhances
