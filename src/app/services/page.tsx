...
export default function Services() {
  const structuredData = {
    ...
    description:
      'Professional therapy services including play therapy for children and talking therapy for adults, addressing anxiety, self-esteem, body image, and relationship issues.',
    offers: [
      {
        '@type': 'Offer',
          ...
          <section className={styles.servicesOverview}>
            <div className={styles.contentGrid}>
              <article className={styles.textContent}>
                ...
                <p>
                  As a qualified therapist in Colchester, I offer professional therapy sessions
                  tailored to support a diverse range of clients and concerns. Whether you&apos;re
                  looking for mental health support in Colchester for face-to-face sessions or
                  prefer online emotional wellbeing therapy, I provide flexible, compassionate
                  psychological therapy to suit your lifestyle and needs.
                </p>
          ...
          <section className={styles.contentEnd}>
            <div className={styles.childrenSection}>
              ...
              <article className={styles.childTextContainer}>
                ...
                <p>
                  <strong>£60 for the therapeutic hour (50 mins)</strong>
                </p>
                <p>
                  As a qualified play therapist in Colchester, I provide children with a natural way
                  to express their feelings and work through challenges. Using toys, games, and
                  creative activities, children can explore difficult emotions in a safe, supportive
                  environment.
                </p>
                <p>
                  This approach is particularly effective for children who may struggle to
                  articulate their feelings verbally, helping them develop emotional resilience and
                  coping strategies.
                </p>
              </article>
            </div>
            ...
            <div className={styles.adultsSection}>
              ...
              <article className={styles.adultTextContainer}>
                ...
                <p>
                  As an experienced therapist in Colchester, I offer individual therapy sessions
                  designed to help you explore your thoughts, feelings, and experiences in a
                  confidential, non-judgmental space. Whether you prefer online or in-person
                  sessions in Colchester, therapy is tailored to your unique needs.
                </p>
                <p>
                  Together, we&apos;ll work to understand patterns, develop coping strategies, and
                  support your journey toward greater self-awareness and emotional well-being.
                </p>
              </article>
            </div>
          </section>

          <section className={styles.ageSpecificServices}>
            <div className={styles.ageServicesContainer}>
              <h2>Therapy Services by Age Group</h2>
              <p className={styles.ageIntro}>
                I specialize in working with people at different life stages, understanding that
                each age group has unique needs, challenges, and ways of communicating. Explore the
                specialized support available for your age group or that of your loved one.
              </p>

              <div className={styles.ageServicesGrid}>
                <div className={styles.ageServiceCard}>
                  <h3>Child Therapy (Ages 5-12)</h3>
                  <p>
                    Specialized therapy for children using play, art, and age-appropriate approaches
                    to help with anxiety, emotions, behavior, family changes, and school
                    difficulties.
                  </p>
                  <ul>
                    <li>Play therapy techniques</li>
                    <li>Family support and guidance</li>
                    <li>School anxiety and avoidance</li>
                    <li>Emotional regulation skills</li>
                    <li>Trauma-informed care</li>
                  </ul>
                  <Link href="/child-therapy" className={buttonStyles.button}>
                ...
                <div className={styles.ageServiceCard}>
                  ...
                  <p>
                    Confidential, respectful therapy for teenagers navigating identity,
                    relationships, school pressure, and the complexities of adolescence.
                  </p>
                  <ul>
                    <li>Identity and self-worth exploration</li>
                    <li>School and social anxiety</li>
                    <li>Family relationship difficulties</li>
                    <li>Depression and mood challenges</li>
                    <li>Confidential therapeutic space</li>
                  </ul>
                  <Link href="/teenage-therapy" className={buttonStyles.button}>
                    Learn More About Teenage Therapy
                  </Link>
                </div>

                <div className={styles.ageServiceCard}>
                  <h3>Young Adult Therapy (Ages 18-30)</h3>
                  <p>
                    Support for young adults navigating life transitions, career challenges,
                    relationships, and the pressures of emerging adulthood.
                  </p>
                  <ul>
                    ...
                    <li>Independence and identity</li>
                  </ul>
                  <Link href="/young-adult-therapy" className={buttonStyles.button}>
                    Learn More About Young Adult Therapy
                  </Link>
                </div>

                <div className={styles.ageServiceCard}>
                  <h3>Neurodiversity & SEN Support</h3>
                  <p>
                    Specialist therapy for neurodivergent individuals including ADHD, autism, and
                    other neurological differences. Drawing on SEN school experience to provide
                    understanding support.
                  </p>
                  <ul>
                    <li>ADHD and autism support</li>
                    <li>Sensory processing challenges</li>
                    <li>Executive function development</li>
                    <li>Strengths-based approach</li>
                    <li>Flexible session adaptations</li>
                  </ul>
                  <Link href="/neurodiversity-therapy" className={buttonStyles.button}>
                    Learn More About Neurodiversity Support
                  </Link>
                </div>

                <div className={styles.ageServiceCard}>
                  <h3>LGBTQ+ Inclusive Therapy</h3>
                  <p>
                    Affirming, inclusive therapy for LGBTQ+ individuals of all ages. Safe space for
                    identity exploration, coming out support, and authentic self-expression.
                  </p>
                  <ul>
                    <li>Identity exploration and affirmation</li>
                    <li>Coming out process support</li>
                    <li>Family and relationship guidance</li>
                    <li>Minority stress and discrimination</li>
                    <li>Intersectionality awareness</li>
                  </ul>
                  <Link href="/lgbtq-therapy" className={buttonStyles.button}>
          ...
          <section className={styles.faqSection}>
            <div className={styles.faqContainer}>
              ...
              <div className={styles.faqItem}>
                ...
                <p>
                  Your first session with me as your Colchester therapist is an opportunity for us
                  to get to know each other. I&apos;ll ask about what brought you to therapy, your
                  goals, and any concerns you might have. We&apos;ll discuss confidentiality, how
                  therapy works, and answer any questions you have. There&apos;s no pressure to
              ...
              <div className={styles.faqItem}>
                ...
                <p>
                  Each therapy session lasts 50 minutes (the therapeutic hour). This gives us enough
                  time to explore your thoughts and feelings while maintaining healthy boundaries.
                  Sessions are scheduled weekly, though frequency can be adjusted based on your
                  individual needs.
                </p>
              </div>
              ...
              <div className={styles.faqItem}>
                ...
                <p>
                  Yes, everything discussed in our sessions is strictly confidential. I follow
                  professional guidelines that protect your privacy. The only exceptions would be if
                  there&apos;s a risk of serious harm to yourself or others, which I would discuss
                  with you first whenever possible.
                </p>
              </div>
              ...
              <div className={styles.faqItem}>
                ...
                <p>
                  The number of sessions varies for each person and depends on your individual goals
                  and circumstances. Some people find benefit in just a few sessions, while others
                  prefer longer-term support. We&apos;ll regularly review your progress together and
                  you&apos;re free to end therapy whenever you feel ready.
                </p>
              </div>
              ...
              <div className={styles.faqItem}>
                ...
                <p>
                  Yes, as a qualified therapist in Colchester, I offer both in-person sessions at my
                  Colchester practice and secure online sessions via video call. Online therapy can
                  be just as effective as in-person sessions and offers flexibility for those with
                  busy schedules or who prefer the comfort of their own space.
                </p>
              </div>
              ...
              <div className={styles.faqItem}>
                ...
                <p>
                  Play therapy is designed specifically for children and uses toys, games, and
                  creative activities as the primary way of communication. Children often express
                  themselves more naturally through play than words. Talking therapy for adults and
                  teenagers focuses on verbal communication to explore thoughts, feelings, and
                  experiences.
                </p>
              </div>
              ...
              <div className={styles.faqItem}>
                ...
                <p>
                  If you&apos;re struggling with your mental health, feeling stuck, or want to
                  understand yourself better, therapy can help. You don&apos;t need to be in crisis
                  to benefit from therapy. It&apos;s a space for personal growth, developing coping
                  strategies, and improving your overall well-being.
                </p>
              </div>
              ...
              <div className={styles.faqItem}>
                ...
                <p>
                  That&apos;s completely normal and absolutely fine. I&apos;m here to help guide our
                  conversations and create a safe space for you to explore your thoughts and
                  feelings. Many people worry about this, but you&apos;ll find that once we start
                  talking, things naturally emerge.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className={styles.locationCoverage}>
            ...
            <div className={styles.coverageGrid}>
              <div className={styles.inPersonServices}>
                ...
                <p>
                  Face-to-face therapy sessions available in central Colchester. Easily accessible
              ...
              <div className={styles.onlineServices}>
                ...
                <p>
                  Secure video therapy sessions for clients across Essex and the UK who prefer
                  online support.
                </p>
                <ul>
          ...
          <section className={styles.credentialsSection}>
            ...
            <div className={styles.credentialsGrid}>
              <div className={styles.credential}>
                ...
                <p>
                  Fully registered therapist following professional ethical guidelines and
              ...
              <div className={styles.credential}>
                ...
                <p>
                  Understanding of local community mental health needs and resources available in
                  the Colchester and Essex area. How does therapy work locally? I know the area
                  well.
                </p>
              </div>
              <div className={styles.credential}>
                ...
                <p>
                  Training in psychodynamic therapy, play therapy, and working with diverse client
                  needs.
                </p>
              </div>
            </div>
          ...
          <section className={styles.therapyFaq}>
            ...
            <div className={styles.faqContainer}>
              <div className={styles.faqItem}>
                ...
                <p>
                  I use psychodynamic therapy principles combined with a warm, non-judgmental
                  approach tailored to each client&apos;s individual needs and circumstances.
                </p>
              </div>
              <div className={styles.faqItem}>
                <h3>How do I know if therapy is right for me?</h3>
              ...
              <div className={styles.faqItem}>
                ...
                <p>
                  Both offer the same therapeutic benefits. In-person sessions provide physical
                  presence, while online therapy offers convenience and accessibility from your own
                  space.
                </p>
              </div>
            </div>
