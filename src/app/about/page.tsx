...
export default function AboutMe() {
  const personSchema = {
    ...
    description:
      'BACP registered psychodynamic psychotherapist in Colchester specializing in therapy for children, adults, and families',
    url: 'https://nextgentherapy.co.uk/about',
    sameAs: ['https://www.bacp.co.uk/search/Therapists'],
    memberOf: {
      '@type': 'Organization',
            ...
            <article className={styles.textContainer}>
              <div className={styles.introSection}>
                ...
                <p>
                  ...
                  Psychodynamic Psychotherapy and a background in Criminology and Social Psychology,
                  both awarded by the University of Essex. Over the past six years, I&apos;ve been
                  providing Colchester therapy services, working with children, young people, and
                  adults across schools, charities, the NHS, and private practice.
                </p>
              </div>
              ...
              <div className={styles.approachSection}>
                <p>
                  ...
                  you&apos;re already feeling vulnerable or stuck. Whether you&apos;re exploring
                  therapy for the first time or have tried it before, my aim is to make the process
                  feel simple, supportive, and respectful from the very start.
                </p>
                <p>
                  Alongside my private practice, I currently work with YMCA Trinity, supporting
                  young people in schools and delivering groups for both students and
                  parents/carers. I&apos;m a registered member of the British Association for
                  Counselling and Psychotherapy (BACP) and I work in accordance with their ethical
                  framework.
                </p>
              </div>
              ...
              <div className={styles.philosophySection}>
                ...
                <p>
                  Therapy isn&apos;t just for when everything falls apart. It can be a powerful
                  space for self-reflection, growth, and healing at any stage of life. Many of my
                  clients come to me when they feel anxious, lost in relationships, critical of
                  themselves, or disconnected from who they are. Some struggle with food, body
                  image, or people-pleasing. Others carry a deep sense of not feeling
                  &quot;enough.&quot;
                </p>
                <p>Whatever brings you here — you&apos;re welcome.</p>
                <p>
                  I offer open-ended therapy, which means we go at your pace. There&apos;s no
                  pressure to share more than you&apos;re ready to. Our work together is grounded in
                  building a strong, authentic connection. I believe this relationship is at the
                  heart of healing.
                </p>
                <p>
              ...
              <div className={styles.practiceSection}>
                ...
                <p>
                  What I&apos;ve learned from working across different systems is that the need for
                  mental health support is growing — and that people are becoming more aware of the
                  emotional weight they carry day to day. That&apos;s why I aim to offer an initial
                  session within one week of your enquiry. I want to make accessing support feel
                  doable, not daunting.
                </p>
                <p>
                  If it turns out I&apos;m not the right fit for you, I&apos;ll do my best to help
                  you find someone who is. Because ultimately, you deserve to feel safe, respected,
