...
export default function TherapyInIpswichPage() {
  const localBusinessSchema = {
    ...
    description:
      'Psychodynamic therapy for women, neurodivergent adults, teenagers and children near Ipswich, Suffolk.',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: 'Therapy near Ipswich',
        item: 'https://nextgentherapy.co.uk/therapy-in-ipswich',
      },
    ],
  };
